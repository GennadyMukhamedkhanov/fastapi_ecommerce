...
class ProductUpdate(BaseModel):
    ...
    Используется PUT запросах.
    """
    name: str | None = Field(None, min_length=3, max_length=100,
                             description="Название товара (3-100 символов)")
    description: str | None = Field(None, max_length=500,
                                    description="Описание товара (до 500 символов)")
    price: Decimal | None = Field(None, gt=0, description="Цена товара (больше 0)", decimal_places=2)
    image_url: str | None = Field(None, max_length=200, description="URL изображения товара")
    stock: int | None = Field(None, ge=0, description="Количество товара на складе (0 или больше)")
...
class UserCreate(BaseModel):
    ...
    password: SecretStr = Field(..., min_length=8, description='Пароль (инимум 8 символов)')
